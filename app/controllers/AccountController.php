...
class AccountController
{
    ...
    public function login()
    {
        ...
        {
            Router::view('pages/login',["error"=>"Au moins un des champs est manquant"]); die();
        }
    ...
    {
        Router::view('pages/inscription'); die();
    }
    /**
     * create new account
     * all required field
    ...
    public function create()
    {
        ...
        {
            Router::view('pages/inscription',["error"=>"Au moins un des champs est manquant"]); die();
        }
        ...
        if ($res)
        {
            Router::view('pages/inscription',["error"=>"Email déjà existant"]); die();
        }
        ...
        if ($res)
        {
            Router::view('pages/inscription',["error"=>"Compte créé"]); die();
        } else
        {
            Router::view('pages/inscription',["error"=>"Compte déjà existant"]); die();
        }
    }
    ...
    public function read()
    {
        ...
        Router::view('pages/compte',["infos" => $res[0]]);
    }
